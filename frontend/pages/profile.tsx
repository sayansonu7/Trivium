...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage(`Error updating profile: ${error instanceof Error ? error.message : 'Unknown error occurred'}`);
    } finally {
      setLoading(false);
    }
  };
            ...
            <div className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-gray-900 font-medium">{userProfile?.phone_number || 'Not provided'}</p>
                      )}
                    </div>
              ...
              <div className="mt-8 pt-6 border-t">
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="text-lg font-medium text-gray-800">Profile Management</h3>
